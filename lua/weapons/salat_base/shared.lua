...
function SWEP:FireBullet()
	...
	--ply:LagCompensation(true) busted
	...
	bullet.IgnoreEntity = IsValid(self:GetOwner()) and self:GetOwner() or IsValid(self:GetOwner().wep) and self:GetOwner().wep or self:GetOwner()
